...
<fieldset>
	...
	<legend accesskey="I" tabindex="<?php echo tab_index() ?>">Informações de reserva</legend>
	...
	<p>
		<label for="room_id" class="required">Sala:</label>
		<?php
		$room_options = array();
	...
	<p>
		<label for="period_id" class="required">Período:</label>
		<?php
...
<fieldset>
	...
	<legend accesskey="R" tabindex="<?php echo tab_index() ?>">Opções recorrentes</legend>
...
<?php
$save_label = empty($booking_id) ? 'Reservar' : 'Save';
