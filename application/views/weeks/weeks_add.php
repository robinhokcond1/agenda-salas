...
<fieldset>
	...
	<p>
		<label for="fgcol" class="required">Cor do primeiro plano</label>
		<?php
		$field = 'fgcol';
...
<fieldset>
	...
	<div>Selecione as datas de início da semana (segunda-feira) dentro do ano empresarial atual ao qual esta semana se aplica.</div>
