<table width="100%">
	<tr>
		...
		<td valign="top">
			...
			<tr>
			<td width="50%" valign="top"><strong>Localização:</strong></td>
			<td><?php echo html_escape($room->location) ?></td>
			</tr>

			<?php if($room->username){ ?>
			<tr>
			<td width="50%" valign="top"><strong>Colaborador:</strong></td>
			...
			<?php if($room->notes){ ?>
			<tr>
			<td width="50%" valign="top"><strong>Referência:</strong></td>
